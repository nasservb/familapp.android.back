...
//main class of  on model layer start 3-2-91 by nasser niazy in 
class GSMS
{
	public static $config=array(	//---------database---------------
									'db_system'=>'mysql',
									'db_hostname'=>'localhost',     
									'db_databasename'=>'نام بانک اطلاعاتی',
									'db_databaseuser'=>'نام کاربری',
									'db_databasepass'=>'رمز',
									'db_charset'=>'utf8',
									'db_return_type'=>'array',
									//------------payment-----------------
									'payment_defualt'=>'mellat_payment',
									...
									'proxy_ips' => '',
									'password_crypt_key' => '22989nu5',		//this value is used in session encode function [crypt('pass','key')]
									'csrf_token_name' => 'csrf_test_name',
									'csrf_cookie_name' => 'csrf_cookie_name',
									'csrf_expire' => 7200,
									//----------url config for config.php------------
									'base_url'	=> 'https://familapp.ir',
									'index_page' => '',
									...
									'photo_small_width' =>200,
									'photo_small_height' =>200,
									'photo_dpi' =>300,//72,
									'photo_format' =>'jpg' 
									);	
