...
//smssender can send any sms in any class [1000,2000,3000,..] . on model layer start 10-2-91 by nasser niazy in 
...
class smssender{
	...
	public function __construct()
	{
		...
		if(!isset(GSMS::$class['nusoap']))
			GSMS::load('soapclient','lib','',GSMS::$config['sms_wsdl_url']);
