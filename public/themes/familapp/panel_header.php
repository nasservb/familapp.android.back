      ...
      <div class="navbar-inner pinkMenu">
        <div class="row">   
			...
			<div class="span4 navbar-form pull-right" style="width:30%">
				<a href="https://cafebazaar.ir/app/Telegram.Group/?l=fa" class="android_link pull-right" title="دریافت نسخه اندروید"><div id="android" ></div> </a>
			...
			<div class="span4  pull-right">
				<form class="navbar-form   pull-left"  role="search" method="get" action="<?php echo $info['user_url']; ?>telgroups/search_result">
			...
			<div  class="span3 pull-left" style="height:40px;float:left " >
				...
				<div id="menu-dd-container" class="menu-dd-container" style="font-family:BKoodakBold">
					<div class="menu-dd-content">
						...
						<a href="<?php echo $info['user_url'] ?>telgroups/insertTelgroup" rel="loadpage">
							<div class="menu-dd-row menu-dd-extra"> ثبت گروه جدید</div>
						</a>
						<div class="menu-divider "></div>
						<a href="<?php echo $info['user_url'] ?>telgroups/listTelgroup" rel="loadpage">
							<div class="menu-dd-row">لیست گروه ها</div>
						</a>
						<div class="menu-divider "></div>
