      ...
      <div class="navbar-inner pinkMenu">
        <div class="row">   
			...
			<div class="span4 navbar-form pull-right">
				<a href="<?php echo $info['super_url']; ?>index" class="pull-right"> <div id="siteLogo" ></div></a>
			...
			<div  class="span4 pull-left" style="height:40px" >
				...
				<div id="menu-dd-container" class="menu-dd-container">
					<div class="menu-dd-content">
						...
						<div class="menu-divider "></div>
						<a href="<?php echo $info['super_url'] ?>" rel="loadpage">
				...
				<div id="menu-dd-container" class="menu-dd-container">
					<div class="menu-dd-content">
						...
						<a href="<?php echo $info['super_url'] ?>" rel="loadpage"><div class="menu-dd-row menu-dd-mobile">ناحیه کاربری</div></a>
