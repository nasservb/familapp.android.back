...
class insertTelchannel
{
    function insertTelchannel($parameter)
    {
        $inf = array('page_title' => 'ثبت کانال');
		...
		<form action="' . GSMS::$class['template']->info['admin_url'] . 'telgroups/insertTelchannel" method="post" enctype="multipart/form-data">
		<div id="notif"></div>
       <table dir="rtl">
