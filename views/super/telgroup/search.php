...
class search
{
    function search($parameter)
    {
        ...
        $body .= '
		<form action="' . GSMS::$class['template']->info['super_url'] . 'telgroups/search_result" method=POST >
			<table dir="rtl"> 
				<tr>
					<td>عنوان  </td>
				...
				<tr>
					<td>شماره ادمین</td>
					<td><input class="rounded raduis" type="text" name="admin" value=""/></td>
				</tr>
				<tr>
					<td>فعال بودن [-1 مهم نیست,0,1,تازه ثبت شده14]</td>
					<td><input class="rounded raduis" type="text" name="accept" value="-1"/></td>
				</tr>
				<tr>
					<td>دسته بندي</td>
