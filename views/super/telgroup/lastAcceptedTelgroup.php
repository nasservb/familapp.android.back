...
class lastAcceptedTelgroup
{

    function lastAcceptedTelgroup($tempGroupArray)
    {

        $inf = array('page_title' => 'ليست گروه های تایید شده');
		...
		$body .= GSMS::$class['template']->paging(
            GSMS::$class['template']->info['super_url'] .  'telgroups/lastAcceptedTelgroup/', $begin, $itemCount);
        ...
        $inf = array('title' => 'ليست گروه های تایید شده', 'body' => $body);
        GSMS::$class['template']->index($inf);
